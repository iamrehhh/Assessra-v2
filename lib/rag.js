...
async function generateEmbedding(text) {
    ...
    // Validate dimensions — helps diagnose mismatches on Vercel
    if (embedding.length !== 1536) {
        console.error(`Embedding dimension mismatch! Got ${embedding.length}, expected 1536. Model: ${response.model}`);
